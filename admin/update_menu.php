                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        <div class="card-header" style="background: teal;">
                            <h4 class="m-b-0 text-white">Ubah Menu</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="row p-t-20">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                ...
                                                <input type="text" name="about" value="<?php echo $roww['slogan']; ?>" class="form-control form-control-danger" placeholder="slogan/keterangan">
                                            </div>
                                        </div>
                                        <!--/span-->
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="res_name" class="form-control custom-select" data-placeholder="Pilih Kategori Resto" tabindex="1">
