            ...
            <div class="page-wrapper" style="height:1200px;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="card p-30" style="background: teal;">
                                <div class="media">
                                    ...
                                    <div class="media-body media-text-right">
                                        <h2 style="color: white; font-weight: 700"><?php $sql = "select * from restaurant";
                                                                                    ...
                                                                                    echo $rws; ?></h2>
                                        <p class="m-b-0" style="color: white;">Resto</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body media-text-right">
                                        <h2 style="color: white; font-weight: 700"><?php $sql = "select * from dishes";
                                                                                    ...
                                                                                    echo $rws; ?></h2>
                                        <p class="m-b-0" style="color: white;">Menu Makanan</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body media-text-right">
                                        <h2 style="color: white; font-weight: 700"><?php $sql = "select * from users";
                                                                                    ...
                                                                                    echo $rws; ?></h2>
                                        <p class="m-b-0" style="color: white;">Users</p>
                                    </div>
                                </div>
                            </div>
                        </div>
