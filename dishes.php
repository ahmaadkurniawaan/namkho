        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Pesan</a></li>
                </ul>
            </div>
        </div>
        <!-- end:Top links -->
            ...
            <div class="row">
                    ...
                    <div class="widget widget-cart">
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <p>Free Shipping</p>
                                <a href="checkout.php?res_id=<?php echo $_GET['res_id']; ?>&action=check" class="btn theme-btn btn-lg">Proses Pesanan</a>
                            </div>
                        </div>
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                    ...
                    <div class="menu-widget" id="2">
                        <div class="widget-heading">
                            <h3 class="widget-title text-dark">
                                Pilih Menu Favorit Kamu! <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
                                    ...
                                    <div class="food-item">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info">
                                                ...
                                                <input type="submit" class="btn theme-btn ctaBtn" style="margin-top:20px; background: rgb(0, 165, 126); color: white;" value="Pesan" />
                                            </div>
                                            </form>
                                        </div>
                                        <!-- end:row -->
